...
const sendToken = (user, statusCode, res) => {
  // Safe Fallback: Checks for both getJWTToken and getJwtToken to eliminate casing crashes
  let token;
...
// Get current user (FIXED: Added validation check to stop TypeError crashes)
